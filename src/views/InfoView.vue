        ...
        <div class="grid-cols-modal lg:grid-cols-modal-xl grid gap-1">
            <div class="modal-body grid grid-cols-2 gap-16  p-2 lg:p-4 max-w-[1200px]">
                <div class="col-span-2">
                    ...
                    <div class="text-base xl:text-lg rte" v-html="state.siteInfo.site_summary_en">
                    </div>
                    ...
                    <div v-if="readMoreActive" class="text-base xl:text-lg rte" v-html="state.siteInfo.site_info_en">
                    </div>
                </div>
                <div class="col-span-2">
